...
setup_5_istio_ambient() {
    log_checkpoint "setup-5: Istio Ambient"
...
EOF
        ...
        # Install ztunnel
        log_info "Installing ztunnel on $context..."
...
EOF
    ...
    log_success "Istio Ambient installed on both clusters"
}
